...
ax = fig.add_axes([0.08, 0.10, 0.84, 0.70], projection="3d"); ax.set_facecolor("#0F1424"); ax.set_axis_off()
...
c = P.reshape(-1, 3); r = np.percentile(np.linalg.norm(c - c.mean(0), axis=1), 85); m = c.mean(0)
